...
const SignUp = () => {
  return <section className={styles.container}>
    ...
    <form className={styles.form}>
      <input className={styles.form__input} type="text" placeholder="Enter your name" name="name" required />
      <input className={styles.form__input} type="email" placeholder="Enter your email" name="email" required />
